...
int main(int argc, char* argv[]) {
	...
	// Creating a list of summable LVPairs named references
	...
	do {
		...
		if (index) {
			...
			// Creating a temporary SummableLVPair from ticketType and number
	...
	// Creating a list of summable LVPairs named ticketSales
